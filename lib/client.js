...
PrintNodeClient.prototype._getJSON = function (path, headers) {
  return this._makeRequest(path, {headers: headers});
};

PrintNodeClient.prototype._postJSON = function (path, body, headers) {
...
PrintNodeClient.prototype._patchJSON = function (path, body, headers) {
  return this._makeRequest(path, {
    method: "PATCH",
    body: body,
    headers: headers
